...
const  Hero = () => {
  ...
  return (
    <DivGrey id='hero' className='snap-start min-h-screen text-gray-300 min-h-screen flex  items-center justify-center'>
      <div className='bg-[#122455] align-center lg:pl-32 rounded-xl m-auto pt-0 px-10 lg:gap-10 min-h-[30rem] h-full flex w-[90%] lg:w-4/5 flex-col lg:flex-row items-center justify-center'>
