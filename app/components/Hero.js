...
const  Hero = () => {
    ...
    return (
        ...
        <div className='bg-[#122455] align-center pl-32 rounded-xl m-auto pt-0 px-10 lg:gap-10 min-h-[40rem] h-full flex sm:w-4/5 flex-col lg:flex-row items-center justify-center'>
            ...
            <div className='pb-32 items-center justify-center w-full bg-red shadow-gray-300 pt-0 mt-0 m-auto'>
