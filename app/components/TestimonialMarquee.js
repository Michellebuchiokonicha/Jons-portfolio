    ...
    <div className="min-h-screen flex flex-col items-center w-full overflow-hidden relative transition-all duration-500">
      <div className="flex animate-marquee space-x-8">
        {[...testimonials, ...testimonials].map((testimonial, index) => (
          <div key={index} className="max-w-[45%] flex-shrink-0 px-4">
            <div className="flex items-center gap-24 p-6 bg-white shadow-xl rounded-lg">
        ...
        {[...testimonials].map((testimonial, index) => (
          <div key={index + testimonials.length} className="max-w-[45%] flex-shrink-0 px-4">
            <div className="flex items-center gap-24 p-6 bg-white shadow-xl rounded-lg">
              <div className="flex-1 bg-[#122455] rounded-lg justify-center items-center m-auto">
                <Image
                  src={testimonial.image}
